...
<input type="text" class="form-control input-sm m-b-xs" id="filter"
			  ...
			  "<form class=\"form-horizontal\" method=\"post\" id=\"retrieve\" action=\"retrieve_problem.php\">
			      <br/><br/><br/>
			        <button input type=\"submit\" class=\"btn btn-sm btn-green m-t-n-xs\" name='problem_identifier' value=\"$retrieve_id\" style=\"width:40%\" type=\"button\"><strong>View/Edit</strong></button>
				  </form>
			  ";
